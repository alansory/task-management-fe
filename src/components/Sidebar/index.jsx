...
const Sidebar = () => {
  ...
  return (
    <div
      className={`transition-all duration-500 fixed top-0 left-0`}
    >
      <div className="flex overflow-y-auto flex-col bg-customBg w-64 px-4 py-8 border-r min-h-screen relative">
        <div className="flex justify-between">
          ...
          <div className="ml-4">
            <p className="m-0">Task Management</p>
            <p className="m-0">Software Project</p>
          </div>
        </div>
        <div className="flex flex-col mt-6 justify-between flex-1">
          <nav className="text">
              ...
              return (
                <Link
                  ...
                  className={`capitalize flex items-center px-4 py-2 ${
                    activeLink === url ? 'bg-gray-200 text-gray-700' : ''
                  } text-gray-600 hover:bg-gray-200 hover:text-gray-700 transition-colors duration-200 transform rounded-md`}
                >
                  {icon}
            ...
            <button
              ...
              className="flex items-center px-4 py-2 mt-0 rounded-md text-gray-600 hover:text-gray-700 hover:bg-gray-200 transition-colors transform"
            >
